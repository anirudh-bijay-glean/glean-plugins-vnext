...
export function formatAvailableSkillsPrompt(
  ...
  const runCodeInstructions =
    ...
    "parameter names. (4) Call `run_code` with JavaScript that invokes each tool " +
    ...
    "run_code is a stateful REPL: variables assigned WITHOUT const/let persist " +
    "across calls until the plugin process exits or you pass reset:true; const/let " +
    "are local to one call.";
